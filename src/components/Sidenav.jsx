...
import {AiOutlineMenu,AiOutlineHome,AiOutlineProject,AiOutlineMail,AiFillAccountBook} from 'react-icons/ai'
            ...
            <AiOutlineMenu onClick={handleNav} className='absolute top-4 right-4 z-[99] md:hidden'/>
            {
                nav ?(
                    <div className='fixed w-full h-screen bg-white/90 flex flex-col justify-center items-center z-20'>
                        <a href="main"className='w-[75%] flex justify-center items-center rounded-full shadow-lg bg-gray-100  shadow-gray-400 m-2 cursor-pointer hover:scale-110 ease-in duration-200'>
                        ...
                        <a href ='#work' className='w-[75%] flex justify-center items-center rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 cusrsor-pointer hover:scale-110 ease-in duration-200'>
                            <HiDocumentReport size={20} className="fill-green-400"/>
                        ...
                        <a href='#contact' className='w-[75%] flex justify-center items-center rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 cursor-pointer hover:scale-110 ease-in duration-200'>
            ...
            <div className='md:block hidden fixed top-[25%] z-10'>
                <div className='flex flex-col'>
                    ...
                    <a href="#work" className='rounded-full shadow-lg bg-gray-700 shadow-green-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300 hover:shadow-cyan-300 hover:shadow-xl  '>
                        <AiFillAccountBook size={20} className='text-cyan-400'  />
                    </a>
